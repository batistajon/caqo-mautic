...
/* @bundles/CoreBundle/Assets/js/libraries/ckeditor/plugins/smiley/dialogs/smiley.js */
class __TwigTemplate_39a93fbf32a11e9bed81613829585569a64cfc928b25a970b29c4e44008c92fd extends Template
{
    private $source;
    private $macros = [];
...
return{title:f.lang.smiley.title,minWidth:270,minHeight:120,contents:[{id:\"tab1\",label:\"\",title:\"\",expand:!0,padding:0,elements:[e]}],buttons:[CKEDITOR.dialog.cancelButton]}});";
    ...
    {
        return "@bundles/CoreBundle/Assets/js/libraries/ckeditor/plugins/smiley/dialogs/smiley.js";
    }
    ...
    {
        return new Source("", "@bundles/CoreBundle/Assets/js/libraries/ckeditor/plugins/smiley/dialogs/smiley.js", "/var/www/html/mautic/docroot/app/bundles/CoreBundle/Assets/js/libraries/ckeditor/plugins/smiley/dialogs/smiley.js");
    }
}
