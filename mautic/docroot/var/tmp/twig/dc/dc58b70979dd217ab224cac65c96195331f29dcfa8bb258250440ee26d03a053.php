...
class __TwigTemplate_361e8cc7edf52688adb867dd54cce322fc5a17d01db043d1fb768e008c750280 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("", "@bundles/CampaignBundle/Executioner/InactiveExecutioner.php", "/var/www/html/mautic/docroot/app/bundles/CampaignBundle/Executioner/InactiveExecutioner.php");
    }
}
