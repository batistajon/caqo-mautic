...
/* @bundles/EmailBundle/Swiftmailer/Momentum/Callback/CallbackEnum.php */
class __TwigTemplate_232d4c40e651dc1f5fefb6b27158886e758b12300db1dd71c7a4d8d2abc4fa2d extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return "@bundles/EmailBundle/Swiftmailer/Momentum/Callback/CallbackEnum.php";
    }
    ...
    {
        return new Source("", "@bundles/EmailBundle/Swiftmailer/Momentum/Callback/CallbackEnum.php", "/var/www/html/mautic/docroot/app/bundles/EmailBundle/Swiftmailer/Momentum/Callback/CallbackEnum.php");
    }
}
