...
/* @bundles/CoreBundle/Assets/js/libraries/ckeditor/plugins/forms/dialogs/textfield.js */
class __TwigTemplate_3228dfe78e9b0570876145d9764a5892045720a71413aabe185921b190a67288 extends Template
{
    private $source;
    private $macros = [];
...
value:\"required\",setup:CKEDITOR.plugins.forms._setupRequiredAttribute,commit:function(a){a=a.element;this.getValue()?a.setAttribute(\"required\",\"required\"):a.removeAttribute(\"required\")}}]}]}});";
    ...
    {
        return "@bundles/CoreBundle/Assets/js/libraries/ckeditor/plugins/forms/dialogs/textfield.js";
    }
    ...
    {
        return new Source("", "@bundles/CoreBundle/Assets/js/libraries/ckeditor/plugins/forms/dialogs/textfield.js", "/var/www/html/mautic/docroot/app/bundles/CoreBundle/Assets/js/libraries/ckeditor/plugins/forms/dialogs/textfield.js");
    }
}
