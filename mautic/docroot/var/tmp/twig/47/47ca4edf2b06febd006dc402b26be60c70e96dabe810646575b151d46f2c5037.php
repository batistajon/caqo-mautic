...
class __TwigTemplate_fce6f800a5f932158dbbba781a17433fe9a1a38aec1da135af5b08f38c631084 extends Template
{
    private $source;
    private $macros = [];
...
@-moz-document url-prefix(){@media screen and (max-width:991px){div.pick-a-color-markup .color-menu{left:0px}}}";
    ...
    {
        return new Source("", "@bundles/PageBundle/Assets/builder/pick-a-color.css", "/var/www/html/mautic/docroot/app/bundles/PageBundle/Assets/builder/pick-a-color.css");
    }
}
