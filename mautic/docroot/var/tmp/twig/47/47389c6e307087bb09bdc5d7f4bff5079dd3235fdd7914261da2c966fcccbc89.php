...
class __TwigTemplate_54cf1d4eeccfa3d55f8fcfa8fb3fcfe029d3b117147e9c1846d05aafaf8e10ea extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("", "@bundles/NotificationBundle/EventListener/ReportSubscriber.php", "/var/www/html/mautic/docroot/app/bundles/NotificationBundle/EventListener/ReportSubscriber.php");
    }
}
