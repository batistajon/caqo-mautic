...
/* @bundles/CoreBundle/Assets/js/libraries/ckeditor/plugins/wsc/dialogs/wsc_ie.js */
class __TwigTemplate_e9942a9e128cebb628c0a2d354c5aad2e7925a9f9ffb4988f274d792c8ad951f extends Template
{
    private $source;
    private $macros = [];
...
CKEDITOR.dialog.on(\"resize\",function(a){a=a.data;var c=a.dialog;\"checkspell\"==c._.name&&((c=(c=c.getContentElement(\"general\",\"content\").getElement())&&c.getChild(2))&&c.setSize(\"height\",a.height),c&&c.setSize(\"width\",a.width))});";
    ...
    {
        return "@bundles/CoreBundle/Assets/js/libraries/ckeditor/plugins/wsc/dialogs/wsc_ie.js";
    }
    ...
    {
        return new Source("", "@bundles/CoreBundle/Assets/js/libraries/ckeditor/plugins/wsc/dialogs/wsc_ie.js", "/var/www/html/mautic/docroot/app/bundles/CoreBundle/Assets/js/libraries/ckeditor/plugins/wsc/dialogs/wsc_ie.js");
    }
}
