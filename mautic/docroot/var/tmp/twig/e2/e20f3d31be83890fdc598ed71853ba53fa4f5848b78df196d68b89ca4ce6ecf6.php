...
class __TwigTemplate_1cb471acc83cac4cd2e893254b7892a92f2681e9d4ffded5e424ebf25f964a93 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("", "@bundles/CoreBundle/CoreEvents.php", "/var/www/html/mautic/docroot/app/bundles/CoreBundle/CoreEvents.php");
    }
}
