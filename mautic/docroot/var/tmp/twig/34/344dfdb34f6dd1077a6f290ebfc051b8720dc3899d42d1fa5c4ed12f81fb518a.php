...
class __TwigTemplate_8d97c0daf50d9e9c4596bf8da0615a26b36a950de202b8fc268ffff7de80be75 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("", "@bundles/CoreBundle/Config/config.php", "/var/www/html/mautic/docroot/app/bundles/CoreBundle/Config/config.php");
    }
}
