...
/* @bundles/CoreBundle/Assets/js/libraries/ckeditor/plugins/colordialog/dialogs/colordialog.js */
class __TwigTemplate_13a575f3650db82168fc5df95097e91e397e793e1952ce86e2aee1bcbf7fb6e2 extends Template
{
    private $source;
    private $macros = [];
...
u+'\"\\x3e\\x26nbsp;\\x3c/div\\x3e\\x3cspan\\x3e'+g.selected+'\\x3c/span\\x3e\\x3cdiv id\\x3d\"'+p+'\" style\\x3d\"border: 1px solid; height: 20px; width: 74px;\"\\x3e\\x3c/div\\x3e'},{type:\"text\",label:g.selected,labelStyle:\"display:none\",id:\"selectedColor\",style:\"width: 76px;margin-top:4px\",onChange:function(){try{h.getById(p).setStyle(\"background-color\",this.getValue())}catch(a){l()}}},C,{type:\"button\",id:\"clear\",label:g.clear,onClick:l}]}]}]}]}});";
    ...
    {
        return "@bundles/CoreBundle/Assets/js/libraries/ckeditor/plugins/colordialog/dialogs/colordialog.js";
    }
    ...
    {
        return new Source("", "@bundles/CoreBundle/Assets/js/libraries/ckeditor/plugins/colordialog/dialogs/colordialog.js", "/var/www/html/mautic/docroot/app/bundles/CoreBundle/Assets/js/libraries/ckeditor/plugins/colordialog/dialogs/colordialog.js");
    }
}
