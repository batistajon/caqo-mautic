...
/* @bundles/CoreBundle/Assets/js/libraries/ckeditor/plugins/pastefromlibreoffice/filter/default.js */
class __TwigTemplate_ff4f2fde7c3d2b60b147c663a302e0e516c0ed88dfac349c4283317e9388aa37 extends Template
{
    private $source;
    private $macros = [];
...
b.attributes.align;b.attributes.style=CKEDITOR.tools.writeCssText(c);return!1}},cellspacing:h,cellpadding:h,border:h}}}};CKEDITOR.pasteFilters.libreoffice=n.createFilter({rules:[p.rules,CKEDITOR.plugins.pastetools.filters.libreoffice.rules]})})();";
    ...
    {
        return "@bundles/CoreBundle/Assets/js/libraries/ckeditor/plugins/pastefromlibreoffice/filter/default.js";
    }
    ...
    {
        return new Source("", "@bundles/CoreBundle/Assets/js/libraries/ckeditor/plugins/pastefromlibreoffice/filter/default.js", "/var/www/html/mautic/docroot/app/bundles/CoreBundle/Assets/js/libraries/ckeditor/plugins/pastefromlibreoffice/filter/default.js");
    }
}
