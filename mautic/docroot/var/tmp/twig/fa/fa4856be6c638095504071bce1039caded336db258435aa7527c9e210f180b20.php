...
class __TwigTemplate_a9c05802fbf0eeeda4c3c2d707717e2db539c151f51fbc5494534a2f5e45d706 extends Template
{
    private $source;
    private $macros = [];
...
.has-error select.form-control + .chosen-container-multi .chosen-choices {
  border-color: @state-danger-text;
    ...
    {
        return new Source("", "@bundles/CoreBundle/Assets/css/libraries/chosen/bootstrap-chosen.less", "/var/www/html/mautic/docroot/app/bundles/CoreBundle/Assets/css/libraries/chosen/bootstrap-chosen.less");
    }
}
