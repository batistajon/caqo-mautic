...
class __TwigTemplate_cfa0476d55dd1e65a79557bc8aace5fb8f84e277db7763f8fcffb9aeb96f3452 extends Template
{
    private $source;
    private $macros = [];
            ...
            if ((($context["profiler_markup_version"] ?? null) == 1)) {
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["name"]) {
                    ...
                    echo "</b>
                        <span>";
                    // line 27
                    echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "messageCount", [$context["name"]], "method", false, false, false, 27), "html", null, true);
                    echo "</span>
                    </div>
                    <div class=\"sf-toolbar-info-piece\">
                        ...
                        <span>";
                    // line 31
                    echo ((twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "isSpool", [$context["name"]], "method", false, false, false, 31)) ? ("yes") : ("no"));
                    echo "</span>
                    </div>
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["name"]) {
                    ...
                    echo "</span>
                        &nbsp; (<small>";
                    // line 43
                    echo ((twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "isSpool", [$context["name"]], "method", false, false, false, 43)) ? ("spooled") : ("sent"));
                    echo "</small>)
                    </div>
                ";
                }
...
";
    ...
    ";
        ...
        if (((($context["profiler_markup_version"] ?? null) == 1) || (twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "mailers", [], "any", false, false, false, 132)) > 1))) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["name"]) {
                ...
                // line 146
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "messageCount", [$context["name"]], "method", false, false, false, 146), "html", null, true);
                echo "</td>
                        <td class=\"font-normal\">";
                // line 147
                echo ((twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "isSpool", [$context["name"]], "method", false, false, false, 147)) ? ("spooled") : ("sent"));
                echo "</td>
                        <td class=\"font-normal\">";
                // line 148
                echo ((twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "isDefaultMailer", [$context["name"]], "method", false, false, false, 148)) ? ("This is the default mailer") : (""));
                echo "</td>
                    </tr>
                ";
            }
    ...
    ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["name"]) {
                ...
                echo "                <div class=\"metric\">
                    <span class=\"value\">";
                // line 157
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "messageCount", [$context["name"]], "method", false, false, false, 157), "html", null, true);
                echo "</span>
                    <span class=\"label\">";
                // line 158
                echo ((twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "isSpool", [$context["name"]], "method", false, false, false, 158)) ? ("spooled") : ("sent"));
                echo " ";
                echo (((twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "messageCount", [$context["name"]], "method", false, false, false, 158) == 1)) ? ("message") : ("messages"));
                echo "</span>
                </div>
            ";
            }
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["name"]) {
            ...
            if ((twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "mailers", [], "any", false, false, false, 165)) > 1)) {
                ...
                <small>";
                // line 168
                echo ((twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "isDefaultMailer", [$context["name"]], "method", false, false, false, 168)) ? ("(default app mailer)") : (""));
                echo "</small>
            </h3>
        ";
            }
        ...
        ";
            // line 172
            if ( !twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "messages", [$context["name"]], "method", false, false, false, 172)) {
                // line 173
                echo "            <div class=\"empty\">
                <p>No e-mail messages were sent.</p>
            </div>
        ";
                ...
                echo "            ";
                $context['_parent'] = $context;
                $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "messages", [$context["name"]], "method", false, false, false, 177));
                $context['loop'] = [
                  'parent' => $context['_parent'],
                  'index0' => 0,
                  'index'  => 1,
                ...
                <div class=\"card\">
                    ...
                    ";
                    // line 246
                    $context["attachments"] = twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "extractAttachments", [$context["message"]], "method", false, false, false, 246);
                    // line 247
                    echo "                    ";
    ...
    {
        return new Source("", "SwiftmailerBundle:Collector:swiftmailer.html.twig", "/var/www/html/mautic/vendor/symfony/swiftmailer-bundle/Resources/views/Collector/swiftmailer.html.twig");
    }
}
