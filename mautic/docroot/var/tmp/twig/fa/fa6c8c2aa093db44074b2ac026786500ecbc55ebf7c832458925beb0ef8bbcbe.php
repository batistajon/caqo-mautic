...
/* @bundles/CoreBundle/Assets/js/libraries/ckeditor/plugins/specialchar/dialogs/lang/el.js */
class __TwigTemplate_3e26d99fd62add1f878660de46680b684c8e0e5b112b1bf82cb1e59cd7c2d175 extends Template
{
    private $source;
    private $macros = [];
...
sbquo:\"Ενιαίο χαμηλο -9 εισαγωγικό \",8219:\"Ενιαίο υψηλο ανεστραμμένο-9 εισαγωγικό \",bdquo:\"Διπλό χαμηλό-9 εισαγωγικό \",hellip:\"Οριζόντια αποσιωπητικά\",trade:\"Σύμβολο εμπορικού κατατεθέν\",9658:\"Μαύρος δείκτης που δείχνει προς τα δεξιά\",bull:\"Κουκκίδα\",rarr:\"Δεξί βελάκι\",rArr:\"Διπλό δεξί βελάκι\",hArr:\"Διπλό βελάκι αριστερά-δεξιά\",diams:\"Μαύρο διαμάντι\",asymp:\"Σχεδόν ίσο με\"});";
    ...
    {
        return "@bundles/CoreBundle/Assets/js/libraries/ckeditor/plugins/specialchar/dialogs/lang/el.js";
    }
    ...
    {
        return new Source("", "@bundles/CoreBundle/Assets/js/libraries/ckeditor/plugins/specialchar/dialogs/lang/el.js", "/var/www/html/mautic/docroot/app/bundles/CoreBundle/Assets/js/libraries/ckeditor/plugins/specialchar/dialogs/lang/el.js");
    }
}
