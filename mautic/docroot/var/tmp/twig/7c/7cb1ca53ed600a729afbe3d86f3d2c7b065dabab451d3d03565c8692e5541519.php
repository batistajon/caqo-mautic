...
class __TwigTemplate_4bca93c230744543f9a8c42312c181840c48fc197cfdfee6110d4578d9ed2303 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        if (((($context["style"] ?? null) != "compact") && twig_get_attribute($this->env, $this->source, ($context["trace"] ?? null), "function", [], "any", false, false, false, 7))) {
            ...
            echo $this->extensions['Symfony\Bridge\Twig\Extension\CodeExtension']->abbrClass(twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["trace"] ?? null), "class", [], "any", false, false, false, 8), "html", null, true));
            echo "</span>";
...
";
    ...
    {
        return new Source("", "TwigBundle:Exception:trace.html.twig", "/var/www/html/mautic/vendor/symfony/twig-bundle/Resources/views/Exception/trace.html.twig");
    }
}
