...
class __TwigTemplate_19dc4a900db03a1b69be4a8d223cb05713149145403bcdd957659a22fbd0ae8d extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("", "@bundles/CoreBundle/Helper/AbstractFormFieldHelper.php", "/var/www/html/mautic/docroot/app/bundles/CoreBundle/Helper/AbstractFormFieldHelper.php");
    }
}
