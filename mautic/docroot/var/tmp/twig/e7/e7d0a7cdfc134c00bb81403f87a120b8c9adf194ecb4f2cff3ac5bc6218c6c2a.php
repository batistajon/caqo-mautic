...
class __TwigTemplate_87a9ebe752d4956b8cd9d83ef7fcfb151b32b54c281d3259e6a8ae6ef332c064 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("", "@bundles/UserBundle/Config/config.php", "/var/www/html/mautic/docroot/app/bundles/UserBundle/Config/config.php");
    }
}
