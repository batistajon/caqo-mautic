...
class __TwigTemplate_b53c0740c242ae53b25a39dfa556e0cd2746eb8b6e0e6dbc3e6cf94d62b872fb extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("", "@bundles/CoreBundle/EventListener/DoctrineEventsSubscriber.php", "/var/www/html/mautic/docroot/app/bundles/CoreBundle/EventListener/DoctrineEventsSubscriber.php");
    }
}
