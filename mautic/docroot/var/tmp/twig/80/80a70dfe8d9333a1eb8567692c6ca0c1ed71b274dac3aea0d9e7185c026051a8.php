...
/* @bundles/EmailBundle/Swiftmailer/Transport/AmazonApiTransport.php */
class __TwigTemplate_c0881d8c703fd0c1677de627ccbdbee274ea7e39b88a9d5dbf43a2d8070fe6de extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return "@bundles/EmailBundle/Swiftmailer/Transport/AmazonApiTransport.php";
    }
    ...
    {
        return new Source("", "@bundles/EmailBundle/Swiftmailer/Transport/AmazonApiTransport.php", "/var/www/html/mautic/docroot/app/bundles/EmailBundle/Swiftmailer/Transport/AmazonApiTransport.php");
    }
}
