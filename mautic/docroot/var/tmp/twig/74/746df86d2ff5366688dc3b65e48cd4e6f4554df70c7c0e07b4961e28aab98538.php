...
class __TwigTemplate_82e9576ee4a1a755d7bfa848a075971470a3d245f55af196994e99351fdf404c extends Template
{
    private $source;
    private $macros = [];
...
mautic.api.error.basic.auth.invalid.credentials=\"Authorization denied, invalid credentials.\"";
    ...
    {
        return new Source("", "@bundles/ApiBundle/Translations/en_US/messages.ini", "/var/www/html/mautic/docroot/app/bundles/ApiBundle/Translations/en_US/messages.ini");
    }
}
