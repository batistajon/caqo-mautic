...
/* @bundles/CoreBundle/Assets/js/libraries/ckeditor/adapters/jquery.js */
class __TwigTemplate_05f259e54764dbdecca9633d53a4e3b04d7045c6aeed820194d1ba8ac027b98e extends Template
{
    private $source;
    private $macros = [];
...
this,k=[],f=this.each(function(){var b=a(this),c=b.data(\"ckeditorInstance\");if(b.is(\"textarea\")&&c){var f=new a.Deferred;c.setData(e,function(){f.resolve()});k.push(f.promise());return!0}return g.call(b,e)});if(k.length){var b=new a.Deferred;a.when.apply(this,k).done(function(){b.resolveWith(m)});return b.promise()}return f}var f=a(this).eq(0),c=f.data(\"ckeditorInstance\");return f.is(\"textarea\")&&c?c.getData():g.call(f)}}))})(window.jQuery);";
    ...
    {
        return "@bundles/CoreBundle/Assets/js/libraries/ckeditor/adapters/jquery.js";
    }
    ...
    {
        return new Source("", "@bundles/CoreBundle/Assets/js/libraries/ckeditor/adapters/jquery.js", "/var/www/html/mautic/docroot/app/bundles/CoreBundle/Assets/js/libraries/ckeditor/adapters/jquery.js");
    }
}
