...
/* @bundles/EmailBundle/Command/ProcessEmailQueueCommand.php */
class __TwigTemplate_ca370590bb25601410121aec7954d1948a06d23206fa6404f4c39bdb8ae49481 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return "@bundles/EmailBundle/Command/ProcessEmailQueueCommand.php";
    }
    ...
    {
        return new Source("", "@bundles/EmailBundle/Command/ProcessEmailQueueCommand.php", "/var/www/html/mautic/docroot/app/bundles/EmailBundle/Command/ProcessEmailQueueCommand.php");
    }
}
