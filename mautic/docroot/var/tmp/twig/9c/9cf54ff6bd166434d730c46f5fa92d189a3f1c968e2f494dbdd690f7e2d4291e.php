...
/* @bundles/CoreBundle/Assets/js/libraries/ckeditor/plugins/pastetools/filter/common.js */
class __TwigTemplate_5100fdd2281776fff53c5eff646e512c047e37a886ac4a0398ec6480c16131f6 extends Template
{
    private $source;
    private $macros = [];
...
\"} \$1\");a=p.rtf.removeGroups(a,\"(?!\"+b+\")\");a=CKEDITOR.tools.trim(a.replace(/^\\{(\\\\[\\w-]+\\s*)+/g,\"\"));return a.replace(/}\$/,\"\")}}})();";
    ...
    {
        return "@bundles/CoreBundle/Assets/js/libraries/ckeditor/plugins/pastetools/filter/common.js";
    }
    ...
    {
        return new Source("", "@bundles/CoreBundle/Assets/js/libraries/ckeditor/plugins/pastetools/filter/common.js", "/var/www/html/mautic/docroot/app/bundles/CoreBundle/Assets/js/libraries/ckeditor/plugins/pastetools/filter/common.js");
    }
}
