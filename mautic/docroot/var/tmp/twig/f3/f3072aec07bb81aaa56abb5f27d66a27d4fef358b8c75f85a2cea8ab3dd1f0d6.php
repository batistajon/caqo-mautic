...
/* @bundles/CoreBundle/Assets/js/libraries/ckeditor/plugins/link/dialogs/link.js */
class __TwigTemplate_22146a8b7a0518f5c7b0617918539f5d911b6f7c3fe610dba5ba868824efc0c3 extends Template
{
    private $source;
    private $macros = [];
...
this.hidePage(\"advanced\");c.config.linkShowTargetTab||this.hidePage(\"target\")},onFocus:function(){var a=this.getContentElement(\"info\",\"linkType\");a&&\"url\"==a.getValue()&&(a=this.getContentElement(\"info\",\"url\"),a.select())}}})})();";
    ...
    {
        return "@bundles/CoreBundle/Assets/js/libraries/ckeditor/plugins/link/dialogs/link.js";
    }
    ...
    {
        return new Source("", "@bundles/CoreBundle/Assets/js/libraries/ckeditor/plugins/link/dialogs/link.js", "/var/www/html/mautic/docroot/app/bundles/CoreBundle/Assets/js/libraries/ckeditor/plugins/link/dialogs/link.js");
    }
}
