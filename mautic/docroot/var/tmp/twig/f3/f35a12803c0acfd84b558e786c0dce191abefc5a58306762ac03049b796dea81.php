...
/* @bundles/CoreBundle/Views/LeftPanel/index.html.twig */
class __TwigTemplate_5a1fbad295ca155a34d6bf51c0e5e06d87c1f2f5d0074f3ea7a0731b771e809b extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        $context["extraMenu"] = $this->extensions['Mautic\CoreBundle\Templating\Twig\Extension\MenuExtension']->menuRender("extra");
        // line 2
        echo "<div class=\"sidebar-header\">
    <!-- brand -->
    <a class=\"mautic-brand";
        // line 4
        echo ((twig_test_empty(($context["extraMenu"] ?? null))) ? ("") : (" pull-left pl-0 pr-0"));
        echo "\" href=\"#\">
        <!-- logo figure -->
    ...
    ";
        // line 43
        if ( !twig_test_empty(($context["extraMenu"] ?? null))) {
            // line 44
            ...
            ";
            // line 48
            echo twig_escape_filter($this->env, ($context["extraMenu"] ?? null), "html", null, true);
            echo "
        </div>
    ";
        }
...
<div class=\"sidebar-content\">
    ...
    <div class=\"scroll-content slimscroll\">
        ...
        <nav class=\"nav-sidebar\">
            ";
        // line 61
        echo $this->extensions['Mautic\CoreBundle\Templating\Twig\Extension\ContentExtension']->getCustomContent("menu.above", ((array_key_exists("mauticTemplateVars", $context)) ? (($context["mauticTemplateVars"] ?? null)) : ([])));
        echo "
            ";
        // line 62
        echo $this->extensions['Mautic\CoreBundle\Templating\Twig\Extension\MenuExtension']->menuRender("main");
        echo "

            <!-- start: left nav -->
            <ul class=\"nav sidebar-left-dark\">
                <li class=\"hidden-xs\">
                    <a href=\"javascript:void(0)\" data-toggle=\"minimize\" class=\"sidebar-minimizer\"><span class=\"direction icon pull-left fa\"></span><span class=\"nav-item-name pull-left text\">";
        // line 67
...
<!--/ end: sidebar-content -->";
    ...
    {
        return "@bundles/CoreBundle/Views/LeftPanel/index.html.twig";
    }
    ...
    {
        return new Source("", "@bundles/CoreBundle/Views/LeftPanel/index.html.twig", "/var/www/html/mautic/docroot/app/bundles/CoreBundle/Views/LeftPanel/index.html.twig");
    }
}
