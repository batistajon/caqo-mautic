...
/* MauticCoreBundle:FormTheme:mautic_form_layout.html.twig */
class __TwigTemplate_2a2361760e3b96f3c8b80ee5d29b0aaa3d406aabff901e41c21ebf29a9ea027f extends Template
{
    private $source;
    private $macros = [];
...
";
        ...
        $context['_seq'] = twig_ensure_traversable(twig_array_filter($this->env, ($context["attr"] ?? null), function ($__v__, $__k__) use ($context, $macros) { $context["v"] = $__v__; $context["k"] = $__k__; return !twig_in_filter($context["k"], ["icon"]); }));
...
($context["attr"] ?? null), "postaddon_text", [], "any", true, true, false, 261) &&  !twig_test_empty(twig_get_attribute($this->env, $this->source, ($context["attr"] ?? null), "postaddon_text", [], "any", false, false, false, 261))))) {
        ...
        ";
            ...
            // line 278
            $this->displayBlock("widget_attributes", $context, $blocks);
            if (( !twig_test_empty(($context["value"] ?? null)) || $this->env->getTest('numeric')->getCallable()(($context["value"] ?? null)))) {
                // line 279
                echo "            value=\"";
...
";
    ...
    public function block_sortable_value_label_list_widget($context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 305
        if (( !is_iterable(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["form"] ?? null), "label", [], "any", false, false, false, 305), "vars", [], "any", false, false, false, 305), "value", [], "any", false, false, false, 305)) &&  !is_iterable(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["form"] ?? null), "value", [], "any", false, false, false, 305), "vars", [], "any", false, false, false, 305), "vale", [], "any", false, false, false, 305)))) {
            // line 306
    ...
    public function block_sortablelist_errors($context, array $blocks = [])
    {
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["error"]) {
            ...
            if (!twig_in_filter(twig_get_attribute($this->env, $this->source, $context["error"], "getMessage", [], "method", false, false, false, 347), ($context["errorMessages"] ?? null))) {
                // line 348
                echo "        ";
                $context["errorMessages"] = twig_array_merge(($context["errorMessages"] ?? null), [twig_get_attribute($this->env, $this->source, $context["error"], "getMessage", [], "method", false, false, false, 348)]);
                // line 349
                echo "    ";
            }
        }
...
";
    ...
    public function block_tel_widget($context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 425
        $this->loadTemplate(["type" => ((array_key_exists("type", $context)) ? (($context["type"] ?? null)) : ($this->env->getFunction('get_class')->getCallable()("Mautic\\CoreBundle\\Form\\Type\\TelType")))], "MauticCoreBundle:FormTheme:mautic_form_layout.html.twig", 425)->displayBlock("form_widget_simple", $context);
        echo "
";
    }
...
";
        // line 462
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable(twig_array_filter($this->env, ($context["attr"] ?? null), function ($__v__, $__k__) use ($context, $macros) { $context["v"] = $__v__; $context["k"] = $__k__; return !twig_in_filter($context["k"], ["tooltip", "preaddon", "preaddon_attr", "postaddon_attr"]); }));
        foreach ($context['_seq'] as $context["k"] => $context["v"]) {
            // line 463
            echo "    ";
...
";
        ...
        if (twig_get_attribute($this->env, $this->source, ($context["attr"] ?? null), "onchange", [], "any", true, true, false, 485)) {
            // line 486
            echo "    ";
            if ( !(is_string($__internal_compile_0 = twig_get_attribute($this->env, $this->source, ($context["attr"] ?? null), "onchange", [], "any", false, false, false, 486)) && is_string($__internal_compile_1 = ";") && str_ends_with($__internal_compile_0, $__internal_compile_1))) {
                // line 487
                echo "        ";
...
";
    ...
    {
        return "MauticCoreBundle:FormTheme:mautic_form_layout.html.twig";
    }
    ...
    {
        return new Source("", "MauticCoreBundle:FormTheme:mautic_form_layout.html.twig", "/var/www/html/mautic/docroot/app/bundles/CoreBundle/Resources/views/FormTheme/mautic_form_layout.html.twig");
    }
}
