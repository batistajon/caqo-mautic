...
/* @bundles/CoreBundle/Templating/Engine/PhpEngine.php */
class __TwigTemplate_74ef8ed3a0cbcadd536003d7a22a0bc022c6271af478c3154cd740e43d5a5eec extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return "@bundles/CoreBundle/Templating/Engine/PhpEngine.php";
    }
    ...
    {
        return new Source("", "@bundles/CoreBundle/Templating/Engine/PhpEngine.php", "/var/www/html/mautic/docroot/app/bundles/CoreBundle/Templating/Engine/PhpEngine.php");
    }
}
